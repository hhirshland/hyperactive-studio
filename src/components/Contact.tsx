          ...
          <div>
            <AnimatedSection>
              ...
              <div className="mt-8 flex flex-col gap-3">
                <a
                  href="mailto:hello@hyperactive.studio"
            ...
            <AnimatedSection delay={0.1}>
              <div className="rounded-lg border border-white/[0.08] bg-white/[0.03] p-6 backdrop-blur-sm">
                ...
                <form className="flex flex-col gap-4">
                  ...
                  <button
                    type="submit"
                    className="mt-1 rounded-md bg-white px-6 py-2.5 text-[13px] font-semibold text-foreground transition-all duration-150 hover:bg-white/90"
                  >
                    Send message
                  </button>
                </form>
